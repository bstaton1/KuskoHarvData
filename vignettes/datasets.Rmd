...
vars_table = function(m, footnote_args = NULL) {
  ...
  kableExtra::kable_styling(full_width = TRUE, bootstrap_options = c("condensed", "striped"), font_size = 12)
...
## `r fa("table")` Completed Trip Interview Records
...
## `r fa("table")` Flight Count Records
